    ...
    <html lang="en" className={`${display.variable} ${body.variable}`}>
      ...
      <body className="min-h-dvh">
        ...
        <MotionProvider>
          <a
            href="#main"
            className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[100] focus:rounded-lg focus:bg-action focus:px-4 focus:py-2 focus:text-white"
          >
            Skip to content
          </a>
          <ScarcityBanner />
