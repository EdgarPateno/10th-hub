    ...
    <div className="glass divide-y divide-line overflow-hidden">
      {items.map((item, i) => (
        <details key={i} className="group">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-5 text-left font-display font-semibold text-ink transition-colors hover:bg-white/[0.06] focus-visible:bg-white/[0.06] [&::-webkit-details-marker]:hidden">
            <span>{item.q}</span>
